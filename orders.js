...
class Ticket {
    constructor(items, orderTime, custmerId){
        this.items = items;
    ...
    updateStatus(newStatus){
        ...
        console.log(`The order for customer ${this.custmerId} is
        now ${this.status}.`);
    }
}
new Ticket("pie", "2;30", "alex").updateStatus("ready")
...
let firstTicket = new Ticket(["pizza", "bread", "soda"],'7;03', 'billy').updateStatus('ready')
